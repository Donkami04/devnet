...
import { HistoricPrtg } from "./HistoricPrtg";
...
export function Categories() {
  ...
  const [showHistoricPrtg, setShowHistoricPrtg] = useState(false);
    ...
    const fetchData = async () => {
      try {
        ...
        dataStatusInfGen.upElements.forEach((e) => {
          ...
          if ((e.rol && e.rol.toLowerCase().includes("lte")) || (e.rol && e.rol.toLowerCase().includes("vmware"))) {
            dataLteUp.push(e);
          }
    ...
    <div>
      ...
      {isLoading ? (
        ...
        <div className="table-ig-categories-container">
          {/* Boton para abrir el historial de caidas de PRTG */}
          <button className="historic-prtg-button" onClick={() => setShowHistoricPrtg(true)}>Histórico caídas PRTG</button>
          <Modal
            isOpen={showHistoricPrtg}
            onClose={() => setShowHistoricPrtg(false)}
            title={"Histórico caídas PRTG"}
            content={<HistoricPrtg />}
            buttons={[]}
            height={"400px"}
            width={"700px"}
          />
          ...
          <table>
            <thead>
              <tr>
                ...
                <th style={{ backgroundColor: "#444444", color: "white" }}>KPI</th>
            ...
            <tbody>
              ...
              <tr>
                <td className="td-category-ig">
                  <Link to="/monitoreo/infraestrucura-general?categoria=fortigate">VPN SITE TO SITE</Link>
                </td>
              ...
              <tr>
                <td className="td-category-ig">
                  <Link to="/monitoreo/infraestrucura-general/certificados">Certificados Candelaria</Link>
                </td>
              ...
              <tr>
                <td className="td-category-ig">
                  <Link to="/monitoreo/infraestrucura-general?categoria=telefonia">Telefonia IP</Link>
                </td>
                <td className={`${kpiCategories.telefonia < 100 ? "kpi-red" : "kpi-green"}`}>
                  {kpiCategories.telefonia}%
                </td>
              ...
              <tr>
                <td className="td-category-ig">
                  <Link to="/monitoreo/infraestrucura-general?categoria=ise">Servidores ISE y PRIME</Link>
                </td>
                <td className={`${kpiCategories.servidoresIsePrime < 100 ? "kpi-red" : "kpi-green"}`}>
                  {kpiCategories.servidoresIsePrime}%
                </td>
                <td>{iseUp.length}</td>
              ...
              <tr>
                <td className="td-category-ig">
                  <Link to="/monitoreo/infraestrucura-general?categoria=inalambricas">Controladoras Inalambricas</Link>
                </td>
                <td className={`${kpiCategories.controladoras < 100 ? "kpi-red" : "kpi-green"}`}>
                  {kpiCategories.controladoras}%
                </td>
              ...
              <tr>
                <td className="td-category-ig">
                  <Link to="/monitoreo/infraestrucura-general?categoria=cctv">Sistema CCTV</Link>
                </td>
              ...
              <tr>
                <td className="td-category-ig">
                  <Link to="/monitoreo/infraestrucura-general?categoria=fw%20it">Firewalls IT</Link>
                </td>
              ...
              <tr>
                <td className="td-category-ig">
                  <Link to="/monitoreo/infraestrucura-general?categoria=fw%20ot">Firewalls OT</Link>
                </td>
              ...
              <tr>
                <td className="td-category-ig">
                  <Link to="/monitoreo/infraestrucura-general/procesos-devnet">Procesos DevNet</Link>
                </td>
              ...
              <tr>
                <td className="td-category-ig">
                  <Link to="/monitoreo/infraestrucura-general?categoria=seguridad">Seguridad</Link>
                </td>
                <td className={`${kpiCategories.seguridad < 100 ? "kpi-red" : "kpi-green"}`}>
                  {kpiCategories.seguridad}%
                </td>
              ...
              <tr>
                <td className="td-category-ig">
                  <Link to="/monitoreo/infraestrucura-general/licenciamientos">Licenciamientos</Link>
                </td>
